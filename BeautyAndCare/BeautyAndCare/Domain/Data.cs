...
namespace BeautyAndCare.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 6, nameOption = "Quản lý User", controller = "adminUser", action = "Index", imageClass = "fa fa-dashboard fa-fw", status = true, isParent = false, parentId = 0 });
