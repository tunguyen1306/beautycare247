...
namespace BeautyAndCare.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 1, nameOption = "Quản lý Menu", controller = "adminMenu", action = "Index", imageClass = "fa fa-dashboard fa-fw", status = true, isParent = false, parentId = 0 });
